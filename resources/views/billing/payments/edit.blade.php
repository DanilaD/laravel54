            ...
            <div class="col-lg-12 col-xs-12">
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Edit payment #{{ $payment->id }}</h3>
                    </div>
                    <div class="panel-body">
                        <div class="pad-btm">
                            ...
                            <form action="{{ url('billing/payments/save') }}" method="post">
                                {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="client_id" class="form-control">
                                                @foreach($clients as $val)
                                                    <option value="{{ $val->id }}" @if ($val->id == $payment->client_id) selected @endif>{{ $val->client_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="date" class="form-control" name="invoice_date" value="{{ $payment->invoice_date }}" required>
                                        </div>
                                    </div>
